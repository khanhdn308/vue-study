<template>
    <div id="content">
        ...
        <div class="form-section">
            <input-form v-for="(item, index) in formItems" :input-detail="item" :key="index" ref="formItems"
                        @close-form="closeForm($event)"></input-form>
        </div>
        <!--Data grid-->
        <div class="grid-section" v-if="cards.length > 0">
        ...
        <div class="carousel-section">
            <card v-for="(item, index) in cards" :key="index" :name="item.name" :age="item.age"
                  :imgName="item.imgName" :imgSource="item.imgSource"></card>
        </div>
    </div>
</template>
            ...
            cards: [
                {
                    name: "Khanh",
                    age: 23,
                    imgSource: "https://i.picsum.photos/id/1048/200/200.jpg?hmac=W94UjOBeBuqxyKnyhht4a81ruXiXHpjQxvdZtNgGyow"
                },
                {
                    name: "Phuc",
                    age: 23,
                    imgSource: "https://i.picsum.photos/id/284/200/200.jpg?hmac=_el2jO-f8UzHfdcTCAXQOD8XX2N6jqVZHwvC23Xm8p8"
                },
                {
                    name: "VA",
                    age: 23,
                    imgSource: "https://i.picsum.photos/id/566/200/200.jpg?hmac=b6_RMcsCCCu5ULi6A3V8vdRrnNhtsnbHdakcGNIQd8s"
                }
            ]
        }
    },
